...
add_action('wp_enqueue_scripts', function () {
  if (defined('IS_VITE_DEVELOPMENT') && IS_VITE_DEVELOPMENT === true) {
    ...
    {
      echo '<script type="module" crossorigin src="//localhost:3000/main.ts"></script>';
    }
    ...
    if (file_exists($manifest_path)) {
      ...
      if (isset($manifest[$main_file])) {
        ...
        wp_enqueue_script('bs-vite-js', $script_url, array(), null, true);
        if (isset($manifest[$main_file]['css'])) {
          foreach ($manifest[$main_file]['css'] as $css_file) {
            ...
            wp_enqueue_style('bs-vite-css', $style_url, array(), null);
          }
        }
      }
    }
